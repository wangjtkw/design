...
public class ServerUnitServicesAdd {
    ...
    public String toString() {
        return "ServerUnitServicesAdd{" +
                ...
                ", serverUnitServicesAirTourNumberLimit='" + serverUnitServicesAirTourNumberLimit + '\'' +
                ", serverUnitServicesAirTourBoardingLocation='" + serverUnitServicesAirTourBoardingLocation + '\'' +
                ", serverUnitServicesAirTourPrice='" + serverUnitServicesAirTourPrice + '\'' +
                ", serverUnitServicesArtificialRainfallAircraftModel='" + serverUnitServicesArtificialRainfallAircraftModel + '\'' +
                ...
                ", serverUnitServicesCharteredAirplaneSeatsNum='" + serverUnitServicesCharteredAirplaneSeatsNum + '\'' +
                ", serverUnitServicesCharteredAirplaneBoardingLocation='" + serverUnitServicesCharteredAirplaneBoardingLocation + '\'' +
